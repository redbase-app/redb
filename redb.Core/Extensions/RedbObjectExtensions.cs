...
namespace redb.Core.Extensions
{
    ...
    public static class RedbObjectExtensions
    {
        ...
        /// <summary>
        /// Checks whether the object has been soft-deleted (scheme changed to @@__deleted).
        /// </summary>
        public static bool IsSoftDeleted(this IRedbObject obj)
            => obj.SchemeId == RedbTypeIds.DeletedScheme;
