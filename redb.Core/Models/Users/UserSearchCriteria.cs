...
namespace redb.Core.Models.Users
{
    ...
    public class UserSearchCriteria
    {
        ...
        /// <summary>
        /// Exact match by login (case-insensitive)
        /// </summary>
        public string? LoginExact { get; set; }
        ...
        /// <summary>
        /// Exact match by email (case-insensitive)
        /// </summary>
        public string? EmailExact { get; set; }
        
        /// <summary>
        /// Login starts with (case-insensitive)
        /// </summary>
        ...
        /// <summary>
        /// Email starts with (case-insensitive)
        /// </summary>
        public string? EmailStartsWith { get; set; }

        /// <summary>
        /// Not equal by login (case-insensitive)
        /// </summary>
        public string? LoginNotEqual { get; set; }

        /// <summary>
        /// Not equal by name (case-insensitive)
        /// </summary>
        public string? NameNotEqual { get; set; }

        /// <summary>
        /// Not equal by email (case-insensitive)
        /// </summary>
