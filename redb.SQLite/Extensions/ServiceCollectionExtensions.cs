...
namespace redb.SQLite.Extensions
{
    ...
    public static class ServiceCollectionExtensions
    {
        ...
        /// </summary>
        [Obsolete("Use services.AddRedb() from redb.SQLite.Extensions.RedbServiceExtensions")]
        ...
        /// </summary>
        [Obsolete("Use services.AddRedb(configuration) from redb.SQLite.Extensions.RedbServiceExtensions")]
        ...
        /// </summary>
        [Obsolete("Use services.AddRedb(options => { ... }) from redb.SQLite.Extensions.RedbServiceExtensions")]
        public static IServiceCollection AddRedbService(
            this IServiceCollection services,
        ...
        /// </summary>
        [Obsolete("Use services.AddRedb(PredefinedConfigurations.GetByName(profile)) from redb.SQLite.Extensions.RedbServiceExtensions")]
        public static IServiceCollection AddRedbService(
            this IServiceCollection services,
            string profileName)
        {
            ...
            string sectionName = "RedbService")
        {
            ...
            services.AddScoped<IRedbService>(provider =>
            {
                ...
                {
                    System.Diagnostics.Debug.WriteLine($"Config monitor setup failed: {ex.Message}");
                }
