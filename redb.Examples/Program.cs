...
class Program
{
    ...
    private static void ConfigureServices(ServiceCollection services)
    {
        ...
        var TestLicense=@"eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCIsImtpZCI6ImFwcC0yMDI1LTAxIn0..nsRNeaXGg_fvy7XOH5P-91OMkcaNq9b3ZJ09TBFHWofhAYU-bmVT6ihFItORHDBLueNuLMXcGzfBB-TFq7c2jor9QvIsX95Bwsqi3FTYHE_Tg3TirAVNybCn8mIKXb_ocoEzx8LfA4wWrrKhHGFJqtJbCBkRPKtwDL515bSC5fzf0gjMyWJ1KpkDbMqpRzLXF0pGmKAEUrTMrJhDlqN7Z0YXdxg-lR1bZQ0vH0OhHoUA8mSjpCcQdoehCmdthiIipuDCaomwLL-uNG2gbDRD-ufgL8SWBR_ramnOToviaWd89bsLx8IA30QRDhKByI163XIAU3xkcFotmVb0EAQcZA";
        services.AddRedbPro(options => options
            .WithLicense(TestLicense)
            .Configure(c =>
            {
                c.EavSaveStrategy = EavSaveStrategy.ChangeTracking; // Default is ChangeTracking - only saves changed props, requires tracking. Can switch to FullSave for simpler logic (always saves all props) or ManualSave for full control (must call SavePropsAsync manually).
